...
export function UnifiedQuickAdd() {
  ...
  return (
    <>
      {/* ── FAB BUTTON ── */}
      <div className="fixed bottom-6 right-6 z-[90] hidden md:flex md:bottom-8 md:right-8">
        ...
        {showMenu && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-4 bottom-[calc(98px+env(safe-area-inset-bottom))] z-[85] mx-auto w-[min(18rem,calc(100vw-2rem))] overflow-hidden rounded-[28px] border border-white/[0.08] bg-[#0E152B]/90 p-5 shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl md:inset-x-auto md:bottom-28 md:right-8 md:mx-0 md:w-72"
            >
